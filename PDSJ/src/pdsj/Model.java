...
public class Model {
    ...
    public void makeAppointment(LocalDate dia, LocalTime horaInicio, String descricao) {
        if (!marcacoes.containsKey(dia)) {
            marcacoes.put(dia, new TreeMap<>());
        }
    ...
    /**
     * Esta função verifica se já existe uma marcação num determinado intervalo
     * de horas
     *
     * @param dia data da marcação a eliminar
    ...
    public boolean verificarDisponibilidadeMarcacao(LocalDate dia, LocalTime horaInicio, LocalTime horaFim) {
        ...
        while (horaInicio != horaFim) {
            ...
            if (values.containsKey(newStartTime)) {
                return false;
            }
     ...
     * @param diaDaSemana que pode ter o valor SEGUNDA, TERÇA, QUARTA, QUINTA,
    ...
    /**
     * Esta função calcula quantos anos, meses e dias existem de diferença entre
     * duas datas.
     *
    ...
    public Period contasDatas(LocalDate data1, LocalDate data2) {
        ...
        Period p = Period.between(data3, data2);
        Period p1 = p.normalized();
        return p1;
    }

    /**
     * Esta função calcula quantas horas, minutos e seguntos existem de
    ...
    /**
     * Esta função calcula quantos anos, meses, dias, horas, minutos e seguntos
     * existem de diferença entre duas datas com as horas associadas.
     *
     * @param data1 data inicial
     * @param data2 data final
     * @param hora1 hora inicial
